...
def cmd_help(args: argparse.Namespace) -> int:
    ...
    logger.info(f"RETRACE (Force Rerun):")
    logger.info("  cbflow run retrace                Remove all stamps (rerun everything)")
    logger.info("  cbflow run retrace --from cts     Retrace from CTS stage onwards")
    logger.info("")
    ...
    logger.info("  cbflow run gen-makefile           Regenerate Makefile from config")
    logger.info("")
