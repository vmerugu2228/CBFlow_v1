...
# ── LEF Tech File ──
# ── Tech LEF per track ──
set tech(9T,lef_tech) "$project(lib_root)/Back_End/lef/gf22nm_9t_tech.lef"
set tech(7.5T,lef_tech) "$project(lib_root)/Back_End/lef/gf22nm_7p5t_tech.lef"
set tech(8T,lef_tech) "$project(lib_root)/Back_End/lef/gf22nm_8t_tech.lef"
