#!/usr/bin/env tclsh
# ═══════════════════════════════════════════════════════════════════════════════
# Metal Stack: gf22naphlogl24uhf116a_9M_2Mx_4Cx_1Jx_2Qx_LB
# Process:     GF 22FDX (22nm FD-SOI)
# Layers:      9 metals — 2 thick (Mx) + 4 intermediate (Cx) + 1 junction (Jx) + 2 thin (Qx)
# Bump:        Local Bump (LB)
# Tech file:   gf22naphlogl24uhf116a_9M_2Mx_4Cx_1Jx_2Qx_LB.tf
# ═══════════════════════════════════════════════════════════════════════════════

set tech(metal_stack_label)  "9M"
set tech(metal_count)        9
set tech(metal_stack_full)   "1P9M_2Mx_4Cx_1Jx_2Qx_LB"

# Tech file for this metal stack
set tech(tech_file)          "$_R/Back_End/tech/gf22naphlogl24uhf116a_9M_2Mx_4Cx_1Jx_2Qx_LB.tf"

# ── Layer Definitions ─────────────────────────────────────────────────────
# Layer order bottom to top
set tech(metal_layers) {M1 M2 M3 M4 M5 M6 M7 M8 M9}
...
set tech(max_routing_layer)       "M8"
set tech(clock_routing_layer_min) "M3"
set tech(clock_routing_layer_max) "M6"
...
# ── Via Definitions ───────────────────────────────────────────────────────
set tech(via_layers) {VIA1 VIA2 VIA3 VIA4 VIA5 VIA6 VIA7 VIA8}

# ── Power Strap Recommendations ──────────────────────────────────────────
# Recommended layers for PG straps (thick metals for low IR drop)
set tech(pg_strap_layers)         {M8 M9}
set tech(pg_strap_secondary)      {M6 M7}
set tech(pg_ring_layer_h)         "M8"
set tech(pg_ring_layer_v)         "M9"
