#!/usr/bin/env tclsh
# ═══════════════════════════════════════════════════════════════════════════════
# Metal Stack: gf22naphlogl24uhf116a_10M_2Mx_5Cx_1Jx_2Qx_LB
# Process:     GF 22FDX (22nm FD-SOI)
# Layers:      10 metals — 2 thick (Mx) + 5 intermediate (Cx) + 1 junction (Jx) + 2 thin (Qx)
# Bump:        Local Bump (LB)
...
set tech(metal_stack_full)   "1P10M_2Mx_5Cx_1Jx_2Qx_LB"

# Tech file for this metal stack
set tech(tech_file)          "$_R/Back_End/tech/gf22naphlogl24uhf116a_10M_2Mx_5Cx_1Jx_2Qx_LB.tf"
...
set tech(max_routing_layer)       "M9"
set tech(clock_routing_layer_min) "M4"
set tech(clock_routing_layer_max) "M7"
