...
array set synth_pnr {
    ...
    subnodes,inputs1          {setup netlist sdc def library upf validate finish}
...
array set synth_pnr {
    ...
    subnode_dependencies,inputs1,validate {setup netlist sdc def library upf}
...
# ┌─ FC-RM Compile Control ────────────────────────────────────────────────┐
array set synth_pnr {
    synthesis,unified_flow        true
    synthesis,qor_metric          "timing"
    synthesis,qor_mode            "balanced"
    synthesis,high_effort_timing  false
    synthesis,enable_spg          false
}
...
array set synth_pnr {
    ...
    signoff,extraction_mode     "fusion_adv"
}
