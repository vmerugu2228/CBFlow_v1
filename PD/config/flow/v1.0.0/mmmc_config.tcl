...
array set analysis_views {
    ...
    "func_ss_0p80v_rctyp_150c" {
        corner "ss" mode "func" voltage 0.80 temperature 150
        analysis_type "setup" constraint_file "ravendrive_func.sdc"
        lib_set_ref "ss_0800v_150c" rc_corner "rc_typ"
        description "Func power leakage: SS, 0.80V, 150C, typ RC"
    }
    "func_tt_0p80v_rctyp_150c" {
    ...
    "func_ff_0p84v_rctyp_25c" {
        ...
        lib_set_ref "ff_0840v_25c" rc_corner "rc_typ"
        description "Func power dynamic: FF, 0.84V, 25C, typ RC"
    }
    "func_ff_0p84v_rcmin_150c" {
...
#   rcmax_cworst  -- C-worst extraction (tighter cap multiplier)
#   rcmin_cbest   -- C-best extraction
#   rcmax_flat    -- Flat extraction model
#   rctyp_T       -- Typical with temperature scaling
# Use 'usage' field to control pairing:
#   "setup_critical" -> pairs with SS corners
#   "hold_critical"  -> pairs with FF corners
#   "nominal"        -> pairs with TT corners
