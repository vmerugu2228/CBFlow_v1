...
array set validation {
    critical_error_ids,SYNTH,genus {
...
array set validation {
    ...
    critical_error_ids,PNR,innovus {
...
array set validation {
    ...
    error_patterns,SYNTH,synthesis {
...
array set validation {
    error_patterns,FP,import_design {
        ".*netlist.*import.*failed.*"
        ".*design.*database.*corruption.*"
        ".*technology.*mismatch.*"
    }

    error_patterns,FP,floorplan {
