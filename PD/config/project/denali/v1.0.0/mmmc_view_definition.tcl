...
# Generated: 2026-06-15 09:48 | Tech: gf_28nm | Project: denali
...
# Variables are referenced via the global namespace ($::) so the
# file works when sourced from inside read_mmmc (a Tcl proc).
