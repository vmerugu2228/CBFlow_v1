#!/usr/bin/env tclsh
# ═══════════════════════════════════════════════════════════════════════════════
# CBFlow SYNTH SYNTHESIS Subnode Handler
# Description: Handles synthesis stage subnodes (setup, run, validate, finish)
...
set cmd_file "$::env(FLOW_DIR)/cmds/SYNTH/cadence/genus/[expr {[info exists ::env(GENUS_VERSION)] ? $::env(GENUS_VERSION) : "v1.0.0"}]/synthesis_genus.tcl"
