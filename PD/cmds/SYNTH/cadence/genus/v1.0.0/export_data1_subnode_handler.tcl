#!/usr/bin/env tclsh
# ═══════════════════════════════════════════════════════════════════════════════
# CBFlow SYNTH EXPORT_DATA Subnode Handler
...
set cmd_file "$::env(FLOW_DIR)/cmds/SYNTH/cadence/genus/[expr {[info exists ::env(GENUS_VERSION)] ? $::env(GENUS_VERSION) : "v1.0.0"}]/export_db_genus.tcl"
