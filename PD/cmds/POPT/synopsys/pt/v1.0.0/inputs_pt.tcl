#!/usr/bin/env tclsh
# CBFlow POPT inputs - Synopsys PrimeTime
...
flow_proc validate_inputs {
    ...
    puts $fp "POPT Input Validation Report - [expr {[catch {clock format [clock seconds] -format {%Y-%m-%d %H:%M:%S}} _ts] ? "epoch [clock seconds]" : $_ts}]"
    puts $fp "============================================================"
