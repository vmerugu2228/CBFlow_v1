...
# Version: Y-2026.03
# Copyright (C) 2014-2026 Synopsys, Inc. All rights reserved.
##########################################################################################
...
if {[sizeof_collection [get_lib_cells -filter "threshold_voltage_group == hvt"]]} {
    set_threshold_voltage_group_type -type high_vt   {hvt}
}

if {[sizeof_collection [get_lib_cells -filter "threshold_voltage_group == svt"]]} {
    set_threshold_voltage_group_type -type normal_vt {svt}
}

if {[sizeof_collection [get_lib_cells -filter "threshold_voltage_group == lvt"]]} {
