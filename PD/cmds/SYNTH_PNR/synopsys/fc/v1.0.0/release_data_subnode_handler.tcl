#!/usr/bin/env tclsh
# ═══════════════════════════════════════════════════════════════════════════════
# CBflow SYNTH_PNR — release_data Subnode Handler (Synopsys FC)
...
handler_load_configs $run_dir "SYNTH_PNR"
...
set cmd_file "$::env(FLOW_DIR)/cmds/SYNTH_PNR/synopsys/fc/$_tool_ver/release_data_fc.tcl"
...
switch $subnode_name {
    ...
    "run" {
        ...
        set _tool [expr {[info exists synth_pnr(tool,name)] ? $synth_pnr(tool,name) : "fc"}]
