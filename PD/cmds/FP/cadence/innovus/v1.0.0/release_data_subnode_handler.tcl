#!/usr/bin/env tclsh
# ═══════════════════════════════════════════════════════════════════════════════
# CBflow FP — release_data Subnode Handler
...
set cmd_file "$::env(FLOW_DIR)/cmds/FP/cadence/innovus/$_tool_ver/release_data_innovus.tcl"

set test_mode [handler_is_test_mode]
set _tool [expr {[info exists ::fp(tool,name)] ? $::fp(tool,name) : "innovus"}]

handler_dispatch $subnode_name $run_dir $::flow_type $node_name $stage_name \
                 $cmd_file $test_mode $_tool "innovus"
