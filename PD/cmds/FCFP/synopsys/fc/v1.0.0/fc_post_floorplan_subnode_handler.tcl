#!/usr/bin/env tclsh
# CBFlow FCFP FC_POST_FLOORPLAN Subnode Handler - Synopsys FC
...
set cmd_file "$::env(FLOW_DIR)/cmds/FCFP/synopsys/fc/$_tool_ver/fc_post_floorplan_fc_post_floorplan_fc.tcl"
set test_mode false
