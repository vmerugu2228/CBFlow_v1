#!/usr/bin/env tclsh
# ═══════════════════════════════════════════════════════════════════════════════
# CBFlow PV MERGE_DATA Subnode Handler
# Description: Handles merge_data stage subnodes (setup, run, validate, finish)
...
set cmd_file "$::env(FLOW_DIR)/cmds/PV/mentor/calibre/$_calibre_ver/merge_data_calibre.tcl"
