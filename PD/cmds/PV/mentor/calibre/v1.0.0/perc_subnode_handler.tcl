#!/usr/bin/env tclsh
# ═══════════════════════════════════════════════════════════════════════════════
# CBFlow PV PERC Subnode Handler
# Description: Handles perc stage subnodes (setup, run, validate, finish)
...
set cmd_file "$::env(FLOW_DIR)/cmds/PV/mentor/calibre/$_calibre_ver/perc_calibre.tcl"
