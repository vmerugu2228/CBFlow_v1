#!/usr/bin/env tclsh
# ═══════════════════════════════════════════════════════════════════════════════
# CBFlow PV XOR Subnode Handler
# Description: Handles xor stage subnodes (setup, run, validate, finish)
...
set cmd_file "$::env(FLOW_DIR)/cmds/PV/mentor/calibre/$_calibre_ver/xor_calibre.tcl"
