#!/usr/bin/env tclsh
# ═══════════════════════════════════════════════════════════════════════════════
# CBFlow PV LVS Subnode Handler
# Description: Handles lvs stage subnodes (setup, run, validate, finish)
...
set cmd_file "$::env(FLOW_DIR)/cmds/PV/mentor/calibre/$_calibre_ver/lvs_calibre.tcl"
