...
flow_proc validate_inputs {
    ...
    # Check top cell name
    if {![info exists project(top_module)] && ![info exists pv(common,top_cell)]} {
        lappend errors "Top cell not defined in project(top_module) or pv(common,top_cell)"
    }
