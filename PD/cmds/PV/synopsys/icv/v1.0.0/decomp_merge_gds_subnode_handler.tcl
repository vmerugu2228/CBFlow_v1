#!/usr/bin/env tclsh
# ═══════════════════════════════════════════════════════════════════════════════
# CBflow PV — decomp_merge_gds Subnode Handler (Synopsys ICV)
...
set cmd_file "$::env(FLOW_DIR)/cmds/PV/synopsys/icv/$_tool_ver/decomp_merge_gds_icv.tcl"

set test_mode [handler_is_test_mode]
set _tool [expr {[info exists ::pv(tool,name)] ? $::pv(tool,name) : "icv"}]
