...
# Description: Handles clp stage subnodes (setup, run, validate, finish)
...
set cmd_file "$::env(FLOW_DIR)/cmds/CLP/cadence/conformal_lp/[expr {[info exists ::env(CONFORMAL_LP_VERSION)] ? $::env(CONFORMAL_LP_VERSION) : "v1.0.0"}]/clp_conformal_lp.tcl"
