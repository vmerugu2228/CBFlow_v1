#!/usr/bin/env tclsh
# ═══════════════════════════════════════════════════════════════════════════════
# CBFlow CLP RELEASE_DATA Subnode Handler
...
set cmd_file "$::env(FLOW_DIR)/cmds/CLP/cadence/conformal_lp/[expr {[info exists ::env(CONFORMAL_LP_VERSION)] ? $::env(CONFORMAL_LP_VERSION) : "v1.0.0"}]/release_data_conformal_lp.tcl"
