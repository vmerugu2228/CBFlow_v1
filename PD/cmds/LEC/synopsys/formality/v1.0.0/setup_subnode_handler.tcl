#!/usr/bin/env tclsh
# ═══════════════════════════════════════════════════════════════════════════════
# CBFlow LEC SETUP Subnode Handler
# Description: Handles setup stage subnodes (setup, run, validate, finish)
...
set cmd_file "$::env(FLOW_DIR)/cmds/LEC/synopsys/formality/[expr {[info exists ::env(FORMALITY_VERSION)] ? $::env(FORMALITY_VERSION) : "v1.0.0"}]/setup_formality.tcl"
