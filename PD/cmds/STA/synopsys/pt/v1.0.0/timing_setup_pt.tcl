#!/usr/bin/env tclsh
# CBFlow STA timing_setup - Synopsys PrimeTime | MMMC-aware setup timing analysis
...
handle_info "Starting STA setup timing with Synopsys PrimeTime..."
...
flow_proc run_setup_timing {
    handle_info "Running MMMC-aware setup timing analysis..."
    ...
    foreach scenario $mmmc_active_scenarios {
        ...
        # Run setup timing analysis (max delay = setup)
        set rpt_file "$::REPORTS_DIR/setup_timing_${scenario}.rpt"
        report_timing -delay_type max -max_paths 100 -input_pins -nets -transition_time \
