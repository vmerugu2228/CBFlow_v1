#!/usr/bin/env tclsh
# CBFlow STA TIMING SCENARIO Handler - Synopsys PT
...
# Source utilities
source -e "$::env(SCRIPTS_ROOT)/utilities/$::env(UTILITIES_VERSION)/error_utils.tcl"

# Source flow config
set flow_config "$::env(CONFIG_ROOT)/flow/$::env(FLOW_CONFIG_VERSION)/flow_config.tcl"
if {[file exists $flow_config]} { source -e $flow_config }
...
if {[file exists $node_config]} { source -e $node_config }
