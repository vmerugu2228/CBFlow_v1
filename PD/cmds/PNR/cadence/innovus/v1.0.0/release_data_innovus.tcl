#!/usr/bin/env tclsh
# ===============================================================================
# CBFlow - PNR Release Data Command File (Innovus)
# Description: Prepare and validate release deliverables for PNR data
...
flow_proc init_release {
    ...
    set design_name [expr {[info exists pnr(design_name)] ? $pnr(design_name) : [expr {[info exists flow(design_name)] ? $flow(design_name) : "pnr"}]}]
...
flow_proc prepare_release {
    ...
    set design_name [expr {[info exists pnr(design_name)] ? $pnr(design_name) : "pnr"}]
