#!/usr/bin/env tclsh
# ═══════════════════════════════════════════════════════════════════════════════
# CBFlow PNR PLACE Subnode Handler
# Description: Handles place stage subnodes (setup, run, validate, finish)
...
set cmd_file "$::env(FLOW_DIR)/cmds/PNR/cadence/innovus/[expr {[info exists ::env(INNOVUS_VERSION)] ? $::env(INNOVUS_VERSION) : "v1.0.0"}]/init_design_innovus.tcl"
