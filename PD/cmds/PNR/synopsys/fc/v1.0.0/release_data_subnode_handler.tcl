#!/usr/bin/env tclsh
# CBFlow PNR RELEASE_DATA1 Subnode Handler - Synopsys FC
...
set cmd_file "$::env(FLOW_DIR)/cmds/PNR/synopsys/fc/$_tool_ver/release_data_fc.tcl"
set test_mode false
...
switch $subnode_name {
    ...
    "run" {
        ...
        if {$test_mode} {
            ...
            set _tool_name [expr {[info exists pnr(tool,name)] ? $pnr(tool,name) : "fc"}]
