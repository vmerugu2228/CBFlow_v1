...
# Description: Handles export_db stage subnodes (setup, run, validate, finish)
...
set cmd_file "$::env(FLOW_DIR)/cmds/ECO/synopsys/icc2/[expr {[info exists ::env(ICC2_VERSION)] ? $::env(ICC2_VERSION) : "v1.0.0"}]/export_db_icc2.tcl"
