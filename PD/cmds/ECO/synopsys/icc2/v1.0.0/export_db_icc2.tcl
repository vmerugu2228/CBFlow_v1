...
#   Write post-ECO GDS stream and save design block
# --------------------------------------------------------------------------
flow_proc export_gds {
    ...
    # Save the design block (ICC2 NDM format)
    set nlib_file "$::OUTPUTS_DIR/db/eco.nlib"
    file mkdir [file dirname $nlib_file]
    save_lib -as $nlib_file
    handle_info "Design library saved: $nlib_file"
}
...
# --------------------------------------------------------------------------
flow_exec_all export_netlist export_def export_gds validate_exports
