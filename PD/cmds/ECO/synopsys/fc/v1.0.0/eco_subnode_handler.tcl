#!/usr/bin/env tclsh
# CBFlow ECO ECO Subnode Handler - Synopsys FC
...
set cmd_file "$::env(FLOW_DIR)/cmds/ECO/synopsys/fc/$_tool_ver/eco_fc.tcl"
set test_mode false
...
switch $subnode_name {
    ...
    "run" {
        ...
        if {$test_mode} {
            ...
            set _tool_name [expr {[info exists eco(tool,name)] ? $eco(tool,name) : "fc"}]
