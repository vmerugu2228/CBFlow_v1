#!/usr/bin/env tclsh
# CBFlow EMIR POWER_ANALYSIS Subnode Handler - Synopsys REDHAWK
...
set cmd_file "$::env(FLOW_DIR)/cmds/EMIR/synopsys/redhawk/$_tool_ver/power_analysis_power_analysis_redhawk.tcl"
set test_mode false
