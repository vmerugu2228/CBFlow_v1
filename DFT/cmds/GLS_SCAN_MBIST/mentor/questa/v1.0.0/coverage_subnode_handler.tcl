#!/usr/bin/env tclsh
# CBflow GLS_SCAN_MBIST — coverage Subnode Handler (questa)
...
handler_load_configs $run_dir "GLS_SCAN_MBIST"
...
set cmd_file  "$_dft_root/cmds/GLS_SCAN_MBIST/mentor/questa/$_tool_ver/${stage_name}_questa.tcl"
