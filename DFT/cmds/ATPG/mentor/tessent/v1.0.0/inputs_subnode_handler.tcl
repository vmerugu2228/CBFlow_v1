#!/usr/bin/env tclsh
# CBFlow ATPG INPUTS Subnode Handler — tessent
# Subnodes: netlist scandef sdf lib
...
set node_config "$::env(CONFIG_ROOT)/flow/$::env(FLOW_CONFIG_VERSION)/node_configs/ATPG_config.tcl"
...
proc _gen_input_subnode {flow node_name sub} {
    ...
    close $fh
    puts "INFO: ATPG $sub completed"
}

switch $subnode_name {
    "netlist" { puts "INFO: ATPG netlist..."; _gen_input_subnode "ATPG" $node_name "netlist" }
    "scandef" { puts "INFO: ATPG scandef..."; _gen_input_subnode "ATPG" $node_name "scandef" }
    "sdf" { puts "INFO: ATPG sdf..."; _gen_input_subnode "ATPG" $node_name "sdf" }
    "lib" { puts "INFO: ATPG lib..."; _gen_input_subnode "ATPG" $node_name "lib" }
