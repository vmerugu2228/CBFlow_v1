#!/usr/bin/env tclsh
# CBflow ATPG — export_patterns Subnode Handler (testmax)
...
set cmd_file  "$_dft_root/cmds/ATPG/synopsys/testmax/$_tool_ver/${stage_name}_testmax.tcl"
...
switch $subnode_name {
    ...
    "run"      { puts "INFO: $stage_name run...";      handler_run      $run_dir $::flow_type $node_name $stage_name $cmd_file $test_mode "testmax" }
