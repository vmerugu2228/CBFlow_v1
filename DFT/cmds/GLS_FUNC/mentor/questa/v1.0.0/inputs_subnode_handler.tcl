#!/usr/bin/env tclsh
# CBFlow GLS_FUNC INPUTS Subnode Handler — questa
# Subnodes: netlist sdf testbench lib
...
set node_config "$::env(CONFIG_ROOT)/flow/$::env(FLOW_CONFIG_VERSION)/node_configs/GLS_FUNC_config.tcl"
...
proc _gen_input_subnode {flow node_name sub} {
    ...
    close $fh
    puts "INFO: GLS_FUNC $sub completed"
}

switch $subnode_name {
    "netlist" { puts "INFO: GLS_FUNC netlist..."; _gen_input_subnode "GLS_FUNC" $node_name "netlist" }
    "sdf" { puts "INFO: GLS_FUNC sdf..."; _gen_input_subnode "GLS_FUNC" $node_name "sdf" }
    "testbench" { puts "INFO: GLS_FUNC testbench..."; _gen_input_subnode "GLS_FUNC" $node_name "testbench" }
    "lib" { puts "INFO: GLS_FUNC lib..."; _gen_input_subnode "GLS_FUNC" $node_name "lib" }
