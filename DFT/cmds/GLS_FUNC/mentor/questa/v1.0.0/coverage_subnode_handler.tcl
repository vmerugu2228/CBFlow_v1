#!/usr/bin/env tclsh
# CBflow GLS_FUNC — coverage Subnode Handler (questa)
...
handler_load_configs $run_dir "GLS_FUNC"

set ::flow_type "GLS_FUNC"
set stage_name  "coverage"
...
set cmd_file  "$_dft_root/cmds/GLS_FUNC/mentor/questa/$_tool_ver/${stage_name}_questa.tcl"
...
switch $subnode_name {
    ...
    "run"      { puts "INFO: $stage_name run...";      handler_run      $run_dir $::flow_type $node_name $stage_name $cmd_file $test_mode "questa" }
