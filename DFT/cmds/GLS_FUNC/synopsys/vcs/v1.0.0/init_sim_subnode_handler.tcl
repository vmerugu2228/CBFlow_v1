#!/usr/bin/env tclsh
# CBflow GLS_FUNC — init_sim Subnode Handler (vcs)
...
set cmd_file  "$_dft_root/cmds/GLS_FUNC/synopsys/vcs/$_tool_ver/${stage_name}_vcs.tcl"
...
switch $subnode_name {
    ...
    "run"      { puts "INFO: $stage_name run...";      handler_run      $run_dir $::flow_type $node_name $stage_name $cmd_file $test_mode "vcs" }
