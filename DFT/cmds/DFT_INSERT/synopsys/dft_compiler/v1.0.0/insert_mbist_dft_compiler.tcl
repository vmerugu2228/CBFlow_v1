#!/usr/bin/env tclsh
# CBFlow DFT_INSERT insert_mbist — dft_compiler
...
flow_proc insert_mbist_run {
    handle_info "DFT_INSERT insert_mbist (dft_compiler) running..."
...
flow_proc insert_mbist_flow { flow_exec insert_mbist_run }
