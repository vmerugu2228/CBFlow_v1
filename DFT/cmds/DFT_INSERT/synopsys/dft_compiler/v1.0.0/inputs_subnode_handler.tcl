#!/usr/bin/env tclsh
# CBFlow DFT_INSERT INPUTS Subnode Handler — dft_compiler
# Subnodes: rtl spec lib
...
proc _gen_input_subnode {flow node_name sub} {
    ...
    close $fh
    puts "INFO: DFT_INSERT $sub completed"
}

switch $subnode_name {
    "rtl" { puts "INFO: DFT_INSERT rtl..."; _gen_input_subnode "DFT_INSERT" $node_name "rtl" }
    "spec" { puts "INFO: DFT_INSERT spec..."; _gen_input_subnode "DFT_INSERT" $node_name "spec" }
    "lib" { puts "INFO: DFT_INSERT lib..."; _gen_input_subnode "DFT_INSERT" $node_name "lib" }
