#!/usr/bin/env tclsh
# CBflow DFT_INSERT — dft_inserted_export Subnode Handler (Mentor Tessent)
...
set _tool_ver [expr {[info exists ::env(TESSENT_VERSION)] ? $::env(TESSENT_VERSION) : "v1.0.0"}]
set _dft_root [expr {[info exists ::env(CBFLOW_DFT_DIR)] ? $::env(CBFLOW_DFT_DIR) : "$::env(FLOW_DIR)/../DFT"}]
set cmd_file  "$_dft_root/cmds/DFT_INSERT/mentor/tessent/$_tool_ver/${stage_name}_tessent.tcl"
