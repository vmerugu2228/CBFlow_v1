#!/usr/bin/env tclsh
# CBflow SCAN_INSERT — scan_export Subnode Handler (dft_compiler)
...
handler_load_configs $run_dir "SCAN_INSERT"
...
set cmd_file  "$_dft_root/cmds/SCAN_INSERT/synopsys/dft_compiler/$_tool_ver/${stage_name}_dft_compiler.tcl"
...
switch $subnode_name {
    ...
    "run"      { puts "INFO: $stage_name run...";      handler_run      $run_dir $::flow_type $node_name $stage_name $cmd_file $test_mode "dft_compiler" }
