# CBFlow FCFP place_pins1 Stage Makefile
...
$(PLACE_PINS1_SETUP_STAMP): $(CREATE_POWER1_STAMP)
	@echo "Running place_pins1 setup..."
	@mkdir -p $(STAMP_DIR) $(LOGS_DIR)
	@tclsh "$(FLOW_DIR)/cmds/FCFP/synopsys/fc/$(FC_VERSION)/place_pins_subnode_handler.tcl" setup "$(PWD)" place_pins1
...
$(PLACE_PINS1_RUN_STAMP): $(PLACE_PINS1_SETUP_STAMP)
	...
	@mkdir -p $(STAMP_DIR) $(LOGS_DIR)
	@tclsh "$(FLOW_DIR)/cmds/FCFP/synopsys/fc/$(FC_VERSION)/place_pins_subnode_handler.tcl" run "$(PWD)" place_pins1
...
$(PLACE_PINS1_VALIDATE_STAMP): $(PLACE_PINS1_RUN_STAMP)
	...
	@mkdir -p $(STAMP_DIR) $(LOGS_DIR)
	@tclsh "$(FLOW_DIR)/cmds/FCFP/synopsys/fc/$(FC_VERSION)/place_pins_subnode_handler.tcl" validate "$(PWD)" place_pins1
...
$(PLACE_PINS1_FINISH_STAMP): $(PLACE_PINS1_VALIDATE_STAMP)
	...
	@mkdir -p $(STAMP_DIR) $(LOGS_DIR)
	@tclsh "$(FLOW_DIR)/cmds/FCFP/synopsys/fc/$(FC_VERSION)/place_pins_subnode_handler.tcl" finish "$(PWD)" place_pins1
