...
$(REPORTING1_SETUP_STAMP): $(TIMING1_STAMP)
	...
	@tclsh "$(FLOW_DIR)/cmds/STA/synopsys/pt/$(PT_VERSION)/reporting_subnode_handler.tcl" setup "$(PWD)" reporting1
...
$(REPORTING1_RUN_STAMP): $(REPORTING1_SETUP_STAMP)
	...
	@mkdir -p $(STAMP_DIR) $(LOGS_DIR)
	@tclsh "$(FLOW_DIR)/cmds/STA/synopsys/pt/$(PT_VERSION)/reporting_subnode_handler.tcl" run "$(PWD)" reporting1
...
$(REPORTING1_VALIDATE_STAMP): $(REPORTING1_RUN_STAMP)
	...
	@mkdir -p $(STAMP_DIR) $(LOGS_DIR)
	@tclsh "$(FLOW_DIR)/cmds/STA/synopsys/pt/$(PT_VERSION)/reporting_subnode_handler.tcl" validate "$(PWD)" reporting1
...
$(REPORTING1_FINISH_STAMP): $(REPORTING1_VALIDATE_STAMP)
	...
	@mkdir -p $(STAMP_DIR) $(LOGS_DIR)
	@tclsh "$(FLOW_DIR)/cmds/STA/synopsys/pt/$(PT_VERSION)/reporting_subnode_handler.tcl" finish "$(PWD)" reporting1
