...
$(CTS_OPT1_SETUP_STAMP): $(CTS1_STAMP)
	...
	@tclsh "$(FLOW_DIR)/cmds/PNR/cadence/innovus/$(INNOVUS_VERSION)/cts_opt_subnode_handler.tcl" setup "$(PWD)" cts_opt1
...
$(CTS_OPT1_RUN_STAMP): $(CTS_OPT1_SETUP_STAMP)
	...
	@mkdir -p $(STAMP_DIR) $(LOGS_DIR)
	@tclsh "$(FLOW_DIR)/cmds/PNR/cadence/innovus/$(INNOVUS_VERSION)/cts_opt_subnode_handler.tcl" run "$(PWD)" cts_opt1
...
$(CTS_OPT1_VALIDATE_STAMP): $(CTS_OPT1_RUN_STAMP)
	...
	@mkdir -p $(STAMP_DIR) $(LOGS_DIR)
	@tclsh "$(FLOW_DIR)/cmds/PNR/cadence/innovus/$(INNOVUS_VERSION)/cts_opt_subnode_handler.tcl" validate "$(PWD)" cts_opt1
...
$(CTS_OPT1_FINISH_STAMP): $(CTS_OPT1_VALIDATE_STAMP)
	...
	@mkdir -p $(STAMP_DIR) $(LOGS_DIR)
	@tclsh "$(FLOW_DIR)/cmds/PNR/cadence/innovus/$(INNOVUS_VERSION)/cts_opt_subnode_handler.tcl" finish "$(PWD)" cts_opt1
