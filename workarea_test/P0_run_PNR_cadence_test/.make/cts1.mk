# CBFlow PNR cts1 Stage Makefile
...
$(CTS1_SETUP_STAMP): $(PLACE1_STAMP)
	...
	@tclsh "$(FLOW_DIR)/cmds/PNR/cadence/innovus/$(INNOVUS_VERSION)/cts_subnode_handler.tcl" setup "$(PWD)" cts1
...
$(CTS1_RUN_STAMP): $(CTS1_SETUP_STAMP)
	...
	@mkdir -p $(STAMP_DIR) $(LOGS_DIR)
	@tclsh "$(FLOW_DIR)/cmds/PNR/cadence/innovus/$(INNOVUS_VERSION)/cts_subnode_handler.tcl" run "$(PWD)" cts1
...
$(CTS1_VALIDATE_STAMP): $(CTS1_RUN_STAMP)
	...
	@mkdir -p $(STAMP_DIR) $(LOGS_DIR)
	@tclsh "$(FLOW_DIR)/cmds/PNR/cadence/innovus/$(INNOVUS_VERSION)/cts_subnode_handler.tcl" validate "$(PWD)" cts1
...
$(CTS1_FINISH_STAMP): $(CTS1_VALIDATE_STAMP)
	...
	@mkdir -p $(STAMP_DIR) $(LOGS_DIR)
	@tclsh "$(FLOW_DIR)/cmds/PNR/cadence/innovus/$(INNOVUS_VERSION)/cts_subnode_handler.tcl" finish "$(PWD)" cts1
