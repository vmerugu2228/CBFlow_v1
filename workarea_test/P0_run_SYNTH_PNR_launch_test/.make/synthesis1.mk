# CBFlow SYNTH_PNR synthesis1 Stage Makefile
...
$(SYNTHESIS1_SETUP_STAMP): $(INIT_DESIGN1_STAMP)
	...
	@tclsh "$(FLOW_DIR)/cmds/SYNTH_PNR/synopsys/fc/$(FC_VERSION)/synthesis_subnode_handler.tcl" setup "$(PWD)" synthesis1
...
$(SYNTHESIS1_RUN_STAMP): $(SYNTHESIS1_SETUP_STAMP)
	...
	@mkdir -p $(STAMP_DIR) $(LOGS_DIR)
	@tclsh "$(FLOW_DIR)/cmds/SYNTH_PNR/synopsys/fc/$(FC_VERSION)/synthesis_subnode_handler.tcl" run "$(PWD)" synthesis1
...
$(SYNTHESIS1_VALIDATE_STAMP): $(SYNTHESIS1_RUN_STAMP)
	...
	@mkdir -p $(STAMP_DIR) $(LOGS_DIR)
	@tclsh "$(FLOW_DIR)/cmds/SYNTH_PNR/synopsys/fc/$(FC_VERSION)/synthesis_subnode_handler.tcl" validate "$(PWD)" synthesis1
...
$(SYNTHESIS1_FINISH_STAMP): $(SYNTHESIS1_VALIDATE_STAMP)
	...
	@mkdir -p $(STAMP_DIR) $(LOGS_DIR)
	@tclsh "$(FLOW_DIR)/cmds/SYNTH_PNR/synopsys/fc/$(FC_VERSION)/synthesis_subnode_handler.tcl" finish "$(PWD)" synthesis1
