# CBFlow FP init_design1 Stage Makefile
...
$(INIT_DESIGN1_SETUP_STAMP): $(INPUTS1_STAMP)
	...
	@tclsh "$(FLOW_DIR)/cmds/FP/synopsys/fc/$(FC_VERSION)/init_design_subnode_handler.tcl" setup "$(PWD)" init_design1
...
$(INIT_DESIGN1_RUN_STAMP): $(INIT_DESIGN1_SETUP_STAMP)
	...
	@mkdir -p $(STAMP_DIR) $(LOGS_DIR)
	@tclsh "$(FLOW_DIR)/cmds/FP/synopsys/fc/$(FC_VERSION)/init_design_subnode_handler.tcl" run "$(PWD)" init_design1
...
$(INIT_DESIGN1_VALIDATE_STAMP): $(INIT_DESIGN1_RUN_STAMP)
	...
	@mkdir -p $(STAMP_DIR) $(LOGS_DIR)
	@tclsh "$(FLOW_DIR)/cmds/FP/synopsys/fc/$(FC_VERSION)/init_design_subnode_handler.tcl" validate "$(PWD)" init_design1
...
$(INIT_DESIGN1_FINISH_STAMP): $(INIT_DESIGN1_VALIDATE_STAMP)
	...
	@mkdir -p $(STAMP_DIR) $(LOGS_DIR)
	@tclsh "$(FLOW_DIR)/cmds/FP/synopsys/fc/$(FC_VERSION)/init_design_subnode_handler.tcl" finish "$(PWD)" init_design1
