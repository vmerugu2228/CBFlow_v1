...
$(ROUTE1_SETUP_STAMP): $(CTS_OPT1_STAMP)
	...
	@tclsh "$(FLOW_DIR)/cmds/PNR/synopsys/fc/$(FC_VERSION)/route_subnode_handler.tcl" setup "$(PWD)" route1
...
$(ROUTE1_RUN_STAMP): $(ROUTE1_SETUP_STAMP)
	...
	@mkdir -p $(STAMP_DIR) $(LOGS_DIR)
	@tclsh "$(FLOW_DIR)/cmds/PNR/synopsys/fc/$(FC_VERSION)/route_subnode_handler.tcl" run "$(PWD)" route1
...
$(ROUTE1_VALIDATE_STAMP): $(ROUTE1_RUN_STAMP)
	...
	@mkdir -p $(STAMP_DIR) $(LOGS_DIR)
	@tclsh "$(FLOW_DIR)/cmds/PNR/synopsys/fc/$(FC_VERSION)/route_subnode_handler.tcl" validate "$(PWD)" route1
...
$(ROUTE1_FINISH_STAMP): $(ROUTE1_VALIDATE_STAMP)
	...
	@mkdir -p $(STAMP_DIR) $(LOGS_DIR)
	@tclsh "$(FLOW_DIR)/cmds/PNR/synopsys/fc/$(FC_VERSION)/route_subnode_handler.tcl" finish "$(PWD)" route1
