...
$(RELEASE_DATA1_SETUP_STAMP): $(EXPORT_DATA1_STAMP)
	...
	@tclsh "$(FLOW_DIR)/cmds/PNR/synopsys/fc/$(FC_VERSION)/release_data_subnode_handler.tcl" setup "$(PWD)" release_data1
...
$(RELEASE_DATA1_RUN_STAMP): $(RELEASE_DATA1_SETUP_STAMP)
	...
	@mkdir -p $(STAMP_DIR) $(LOGS_DIR)
	@tclsh "$(FLOW_DIR)/cmds/PNR/synopsys/fc/$(FC_VERSION)/release_data_subnode_handler.tcl" run "$(PWD)" release_data1
...
$(RELEASE_DATA1_VALIDATE_STAMP): $(RELEASE_DATA1_RUN_STAMP)
	...
	@mkdir -p $(STAMP_DIR) $(LOGS_DIR)
	@tclsh "$(FLOW_DIR)/cmds/PNR/synopsys/fc/$(FC_VERSION)/release_data_subnode_handler.tcl" validate "$(PWD)" release_data1
...
$(RELEASE_DATA1_FINISH_STAMP): $(RELEASE_DATA1_VALIDATE_STAMP)
	...
	@mkdir -p $(STAMP_DIR) $(LOGS_DIR)
	@tclsh "$(FLOW_DIR)/cmds/PNR/synopsys/fc/$(FC_VERSION)/release_data_subnode_handler.tcl" finish "$(PWD)" release_data1
