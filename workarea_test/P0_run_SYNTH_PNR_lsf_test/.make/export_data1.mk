# CBFlow SYNTH_PNR export_data1 Stage Makefile
...
$(EXPORT_DATA1_SETUP_STAMP): $(SIGNOFF1_STAMP)
	...
	@tclsh "$(FLOW_DIR)/cmds/SYNTH_PNR/synopsys/fc/$(FC_VERSION)/export_data_subnode_handler.tcl" setup "$(PWD)" export_data1
...
$(EXPORT_DATA1_RUN_STAMP): $(EXPORT_DATA1_SETUP_STAMP)
	...
	@mkdir -p $(STAMP_DIR) $(LOGS_DIR)
	@tclsh "$(FLOW_DIR)/cmds/SYNTH_PNR/synopsys/fc/$(FC_VERSION)/export_data_subnode_handler.tcl" run "$(PWD)" export_data1
...
$(EXPORT_DATA1_VALIDATE_STAMP): $(EXPORT_DATA1_RUN_STAMP)
	...
	@mkdir -p $(STAMP_DIR) $(LOGS_DIR)
	@tclsh "$(FLOW_DIR)/cmds/SYNTH_PNR/synopsys/fc/$(FC_VERSION)/export_data_subnode_handler.tcl" validate "$(PWD)" export_data1
...
$(EXPORT_DATA1_FINISH_STAMP): $(EXPORT_DATA1_VALIDATE_STAMP)
	...
	@mkdir -p $(STAMP_DIR) $(LOGS_DIR)
	@tclsh "$(FLOW_DIR)/cmds/SYNTH_PNR/synopsys/fc/$(FC_VERSION)/export_data_subnode_handler.tcl" finish "$(PWD)" export_data1
