...
# inputs1 stage with subnodes: setup, netlist, sdc, def, library, upf, validate, finish
...
$(INPUTS1_STAMP): $(INPUTS1_SETUP_STAMP) $(INPUTS1_NETLIST_STAMP) $(INPUTS1_SDC_STAMP) $(INPUTS1_DEF_STAMP) $(INPUTS1_LIBRARY_STAMP) $(INPUTS1_UPF_STAMP) $(INPUTS1_VALIDATE_STAMP) $(INPUTS1_FINISH_STAMP)
...
$(INPUTS1_NETLIST_STAMP): 
	...
	@mkdir -p $(STAMP_DIR) $(LOGS_DIR)
	@tclsh "$(FLOW_DIR)/cmds/SYNTH_PNR/synopsys/fc/$(FC_VERSION)/inputs_subnode_handler.tcl" netlist "$(PWD)" inputs1
...
$(INPUTS1_DEF_STAMP): 
	...
	@mkdir -p $(STAMP_DIR) $(LOGS_DIR)
	@tclsh "$(FLOW_DIR)/cmds/SYNTH_PNR/synopsys/fc/$(FC_VERSION)/inputs_subnode_handler.tcl" def "$(PWD)" inputs1
...
$(INPUTS1_LIBRARY_STAMP): 
	...
	@mkdir -p $(STAMP_DIR) $(LOGS_DIR)
	@tclsh "$(FLOW_DIR)/cmds/SYNTH_PNR/synopsys/fc/$(FC_VERSION)/inputs_subnode_handler.tcl" library "$(PWD)" inputs1
...
$(INPUTS1_VALIDATE_STAMP): $(INPUTS1_SETUP_STAMP) $(INPUTS1_NETLIST_STAMP) $(INPUTS1_SDC_STAMP) $(INPUTS1_DEF_STAMP) $(INPUTS1_LIBRARY_STAMP) $(INPUTS1_UPF_STAMP)
