# CBFlow SYNTH_PNR signoff1 Stage Makefile
...
$(SIGNOFF1_SETUP_STAMP): $(PRO1_STAMP)
	...
	@tclsh "$(FLOW_DIR)/cmds/SYNTH_PNR/synopsys/fc/$(FC_VERSION)/signoff_subnode_handler.tcl" setup "$(PWD)" signoff1
...
$(SIGNOFF1_RUN_STAMP): $(SIGNOFF1_SETUP_STAMP)
	...
	@mkdir -p $(STAMP_DIR) $(LOGS_DIR)
	@tclsh "$(FLOW_DIR)/cmds/SYNTH_PNR/synopsys/fc/$(FC_VERSION)/signoff_subnode_handler.tcl" run "$(PWD)" signoff1
...
$(SIGNOFF1_VALIDATE_STAMP): $(SIGNOFF1_RUN_STAMP)
	...
	@mkdir -p $(STAMP_DIR) $(LOGS_DIR)
	@tclsh "$(FLOW_DIR)/cmds/SYNTH_PNR/synopsys/fc/$(FC_VERSION)/signoff_subnode_handler.tcl" validate "$(PWD)" signoff1
...
$(SIGNOFF1_FINISH_STAMP): $(SIGNOFF1_VALIDATE_STAMP)
	...
	@mkdir -p $(STAMP_DIR) $(LOGS_DIR)
	@tclsh "$(FLOW_DIR)/cmds/SYNTH_PNR/synopsys/fc/$(FC_VERSION)/signoff_subnode_handler.tcl" finish "$(PWD)" signoff1
