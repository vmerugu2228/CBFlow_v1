# CBFlow EMIR inputs1 Stage Makefile
# Auto-generated for EMIR flow

# inputs1 stage with subnodes: setup, netlist, def, spef, library, validate, finish
...
$(INPUTS1_STAMP): $(INPUTS1_SETUP_STAMP) $(INPUTS1_NETLIST_STAMP) $(INPUTS1_DEF_STAMP) $(INPUTS1_SPEF_STAMP) $(INPUTS1_LIBRARY_STAMP) $(INPUTS1_VALIDATE_STAMP) $(INPUTS1_FINISH_STAMP)
...
$(INPUTS1_SETUP_STAMP): 
	...
	@tclsh "$(FLOW_DIR)/cmds/EMIR/synopsys/redhawk/$(REDHAWK_VERSION)/inputs_subnode_handler.tcl" setup "$(PWD)" inputs1
...
$(INPUTS1_NETLIST_STAMP): $(INPUTS1_SETUP_STAMP)
	...
	@mkdir -p $(STAMP_DIR) $(LOGS_DIR)
	@tclsh "$(FLOW_DIR)/cmds/EMIR/synopsys/redhawk/$(REDHAWK_VERSION)/inputs_subnode_handler.tcl" netlist "$(PWD)" inputs1
...
$(INPUTS1_DEF_STAMP): $(INPUTS1_SETUP_STAMP)
	...
	@mkdir -p $(STAMP_DIR) $(LOGS_DIR)
	@tclsh "$(FLOW_DIR)/cmds/EMIR/synopsys/redhawk/$(REDHAWK_VERSION)/inputs_subnode_handler.tcl" def "$(PWD)" inputs1
...
$(INPUTS1_SPEF_STAMP): $(INPUTS1_SETUP_STAMP)
	...
	@mkdir -p $(STAMP_DIR) $(LOGS_DIR)
	@tclsh "$(FLOW_DIR)/cmds/EMIR/synopsys/redhawk/$(REDHAWK_VERSION)/inputs_subnode_handler.tcl" spef "$(PWD)" inputs1
...
$(INPUTS1_LIBRARY_STAMP): $(INPUTS1_SETUP_STAMP)
	...
	@mkdir -p $(STAMP_DIR) $(LOGS_DIR)
	@tclsh "$(FLOW_DIR)/cmds/EMIR/synopsys/redhawk/$(REDHAWK_VERSION)/inputs_subnode_handler.tcl" library "$(PWD)" inputs1
	@echo "done inputs1 library completed"
	@touch $@

# inputs1 validate subnode
$(INPUTS1_VALIDATE_STAMP): $(INPUTS1_NETLIST_STAMP) $(INPUTS1_DEF_STAMP) $(INPUTS1_SPEF_STAMP) $(INPUTS1_LIBRARY_STAMP)
	@echo "Running inputs1 validate..."
	@mkdir -p $(STAMP_DIR) $(LOGS_DIR)
	@tclsh "$(FLOW_DIR)/cmds/EMIR/synopsys/redhawk/$(REDHAWK_VERSION)/inputs_subnode_handler.tcl" validate "$(PWD)" inputs1
...
$(INPUTS1_FINISH_STAMP): $(INPUTS1_VALIDATE_STAMP)
	...
	@mkdir -p $(STAMP_DIR) $(LOGS_DIR)
	@tclsh "$(FLOW_DIR)/cmds/EMIR/synopsys/redhawk/$(REDHAWK_VERSION)/inputs_subnode_handler.tcl" finish "$(PWD)" inputs1
