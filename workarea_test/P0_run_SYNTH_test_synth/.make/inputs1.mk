# CBFlow SYNTH inputs1 Stage Makefile
...
$(INPUTS1_SETUP_STAMP): 
	...
	@tclsh "$(FLOW_DIR)/cmds/SYNTH/synopsys/fc/$(FC_VERSION)/inputs_subnode_handler.tcl" setup "$(PWD)" inputs1
...
$(INPUTS1_RTL_STAMP): 
	...
	@mkdir -p $(STAMP_DIR) $(LOGS_DIR)
	@tclsh "$(FLOW_DIR)/cmds/SYNTH/synopsys/fc/$(FC_VERSION)/inputs_subnode_handler.tcl" rtl "$(PWD)" inputs1
...
$(INPUTS1_SDC_STAMP): 
	...
	@mkdir -p $(STAMP_DIR) $(LOGS_DIR)
	@tclsh "$(FLOW_DIR)/cmds/SYNTH/synopsys/fc/$(FC_VERSION)/inputs_subnode_handler.tcl" sdc "$(PWD)" inputs1
...
$(INPUTS1_UPF_STAMP): 
	...
	@mkdir -p $(STAMP_DIR) $(LOGS_DIR)
	@tclsh "$(FLOW_DIR)/cmds/SYNTH/synopsys/fc/$(FC_VERSION)/inputs_subnode_handler.tcl" upf "$(PWD)" inputs1
...
$(INPUTS1_VALIDATE_STAMP): $(INPUTS1_SETUP_STAMP) $(INPUTS1_RTL_STAMP) $(INPUTS1_SDC_STAMP) $(INPUTS1_UPF_STAMP)
	...
	@mkdir -p $(STAMP_DIR) $(LOGS_DIR)
	@tclsh "$(FLOW_DIR)/cmds/SYNTH/synopsys/fc/$(FC_VERSION)/inputs_subnode_handler.tcl" validate "$(PWD)" inputs1
...
$(INPUTS1_FINISH_STAMP): $(INPUTS1_VALIDATE_STAMP)
	...
	@mkdir -p $(STAMP_DIR) $(LOGS_DIR)
	@tclsh "$(FLOW_DIR)/cmds/SYNTH/synopsys/fc/$(FC_VERSION)/inputs_subnode_handler.tcl" finish "$(PWD)" inputs1
