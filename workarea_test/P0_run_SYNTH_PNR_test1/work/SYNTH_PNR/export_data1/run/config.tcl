...
puts "INFO: Loading consolidated config for SYNTH_PNR export_data1 (export_data1_default)"
...
puts "INFO: Consolidated configuration loading complete for SYNTH_PNR export_data1 (export_data1_default)"
