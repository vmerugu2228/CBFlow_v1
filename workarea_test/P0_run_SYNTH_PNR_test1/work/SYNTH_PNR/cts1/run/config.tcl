#!/usr/bin/env tclsh
# ═══════════════════════════════════════════════════════════════════════════════
# CBFlow - Consolidated Config for SYNTH_PNR cts1 (cts1_default)
...
puts "INFO: Loading consolidated config for SYNTH_PNR cts1 (cts1_default)"
...
puts "INFO: Consolidated configuration loading complete for SYNTH_PNR cts1 (cts1_default)"
