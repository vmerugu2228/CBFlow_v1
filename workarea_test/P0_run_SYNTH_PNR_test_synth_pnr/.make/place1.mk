# CBFlow SYNTH_PNR place1 Stage Makefile
...
$(PLACE1_SETUP_STAMP): $(SYNTHESIS1_STAMP)
	@echo "Running place1 setup..."
	@mkdir -p $(STAMP_DIR) $(LOGS_DIR)
	@tclsh "$(FLOW_DIR)/cmds/SYNTH_PNR/synopsys/fc/$(FC_VERSION)/place_subnode_handler.tcl" setup "$(PWD)" place1
...
$(PLACE1_RUN_STAMP): $(PLACE1_SETUP_STAMP)
	...
	@mkdir -p $(STAMP_DIR) $(LOGS_DIR)
	@tclsh "$(FLOW_DIR)/cmds/SYNTH_PNR/synopsys/fc/$(FC_VERSION)/place_subnode_handler.tcl" run "$(PWD)" place1
...
$(PLACE1_VALIDATE_STAMP): $(PLACE1_RUN_STAMP)
	...
	@mkdir -p $(STAMP_DIR) $(LOGS_DIR)
	@tclsh "$(FLOW_DIR)/cmds/SYNTH_PNR/synopsys/fc/$(FC_VERSION)/place_subnode_handler.tcl" validate "$(PWD)" place1
...
$(PLACE1_FINISH_STAMP): $(PLACE1_VALIDATE_STAMP)
	...
	@mkdir -p $(STAMP_DIR) $(LOGS_DIR)
	@tclsh "$(FLOW_DIR)/cmds/SYNTH_PNR/synopsys/fc/$(FC_VERSION)/place_subnode_handler.tcl" finish "$(PWD)" place1
