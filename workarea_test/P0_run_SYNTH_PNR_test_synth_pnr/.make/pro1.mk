# CBFlow SYNTH_PNR pro1 Stage Makefile
...
$(PRO1_SETUP_STAMP): $(ROUTE1_STAMP)
	...
	@tclsh "$(FLOW_DIR)/cmds/SYNTH_PNR/synopsys/fc/$(FC_VERSION)/pro_subnode_handler.tcl" setup "$(PWD)" pro1
...
$(PRO1_RUN_STAMP): $(PRO1_SETUP_STAMP)
	...
	@mkdir -p $(STAMP_DIR) $(LOGS_DIR)
	@tclsh "$(FLOW_DIR)/cmds/SYNTH_PNR/synopsys/fc/$(FC_VERSION)/pro_subnode_handler.tcl" run "$(PWD)" pro1
...
$(PRO1_VALIDATE_STAMP): $(PRO1_RUN_STAMP)
	...
	@mkdir -p $(STAMP_DIR) $(LOGS_DIR)
	@tclsh "$(FLOW_DIR)/cmds/SYNTH_PNR/synopsys/fc/$(FC_VERSION)/pro_subnode_handler.tcl" validate "$(PWD)" pro1
...
$(PRO1_FINISH_STAMP): $(PRO1_VALIDATE_STAMP)
	...
	@mkdir -p $(STAMP_DIR) $(LOGS_DIR)
	@tclsh "$(FLOW_DIR)/cmds/SYNTH_PNR/synopsys/fc/$(FC_VERSION)/pro_subnode_handler.tcl" finish "$(PWD)" pro1
