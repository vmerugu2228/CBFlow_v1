...
$(INPUTS1_SETUP_STAMP): 
	...
	@tclsh "$(FLOW_DIR)/cmds/STA/cadence/tempus/$(TEMPUS_VERSION)/inputs_subnode_handler.tcl" setup "$(PWD)" inputs1
...
$(INPUTS1_NETLIST_STAMP): $(INPUTS1_SETUP_STAMP)
	...
	@mkdir -p $(STAMP_DIR) $(LOGS_DIR)
	@tclsh "$(FLOW_DIR)/cmds/STA/cadence/tempus/$(TEMPUS_VERSION)/inputs_subnode_handler.tcl" netlist "$(PWD)" inputs1
...
$(INPUTS1_SDC_STAMP): $(INPUTS1_SETUP_STAMP)
	...
	@mkdir -p $(STAMP_DIR) $(LOGS_DIR)
	@tclsh "$(FLOW_DIR)/cmds/STA/cadence/tempus/$(TEMPUS_VERSION)/inputs_subnode_handler.tcl" sdc "$(PWD)" inputs1
...
$(INPUTS1_SPEF_STAMP): $(INPUTS1_SETUP_STAMP)
	...
	@mkdir -p $(STAMP_DIR) $(LOGS_DIR)
	@tclsh "$(FLOW_DIR)/cmds/STA/cadence/tempus/$(TEMPUS_VERSION)/inputs_subnode_handler.tcl" spef "$(PWD)" inputs1
...
$(INPUTS1_LIBRARY_STAMP): $(INPUTS1_SETUP_STAMP)
	...
	@mkdir -p $(STAMP_DIR) $(LOGS_DIR)
	@tclsh "$(FLOW_DIR)/cmds/STA/cadence/tempus/$(TEMPUS_VERSION)/inputs_subnode_handler.tcl" library "$(PWD)" inputs1
...
$(INPUTS1_VALIDATE_STAMP): $(INPUTS1_NETLIST_STAMP) $(INPUTS1_SDC_STAMP) $(INPUTS1_SPEF_STAMP) $(INPUTS1_LIBRARY_STAMP)
	...
	@mkdir -p $(STAMP_DIR) $(LOGS_DIR)
	@tclsh "$(FLOW_DIR)/cmds/STA/cadence/tempus/$(TEMPUS_VERSION)/inputs_subnode_handler.tcl" validate "$(PWD)" inputs1
...
$(INPUTS1_FINISH_STAMP): $(INPUTS1_VALIDATE_STAMP)
	...
	@mkdir -p $(STAMP_DIR) $(LOGS_DIR)
	@tclsh "$(FLOW_DIR)/cmds/STA/cadence/tempus/$(TEMPUS_VERSION)/inputs_subnode_handler.tcl" finish "$(PWD)" inputs1
