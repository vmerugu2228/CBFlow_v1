...
$(EXTRACTION1_SETUP_STAMP): $(INPUTS1_STAMP)
	...
	@tclsh "$(FLOW_DIR)/cmds/STA/cadence/tempus/$(TEMPUS_VERSION)/extraction_subnode_handler.tcl" setup "$(PWD)" extraction1
...
$(EXTRACTION1_RUN_STAMP): $(EXTRACTION1_SETUP_STAMP)
	...
	@mkdir -p $(STAMP_DIR) $(LOGS_DIR)
	@tclsh "$(FLOW_DIR)/cmds/STA/cadence/tempus/$(TEMPUS_VERSION)/extraction_subnode_handler.tcl" run "$(PWD)" extraction1
...
$(EXTRACTION1_VALIDATE_STAMP): $(EXTRACTION1_RUN_STAMP)
	...
	@mkdir -p $(STAMP_DIR) $(LOGS_DIR)
	@tclsh "$(FLOW_DIR)/cmds/STA/cadence/tempus/$(TEMPUS_VERSION)/extraction_subnode_handler.tcl" validate "$(PWD)" extraction1
...
$(EXTRACTION1_FINISH_STAMP): $(EXTRACTION1_VALIDATE_STAMP)
	...
	@mkdir -p $(STAMP_DIR) $(LOGS_DIR)
	@tclsh "$(FLOW_DIR)/cmds/STA/cadence/tempus/$(TEMPUS_VERSION)/extraction_subnode_handler.tcl" finish "$(PWD)" extraction1
